...
const Card = ({ _id, name , photo, prompt }) => {
  return (
        ...
        <div className='group-hover:flex flex-col max-h-[94.5%] hidden absolute bottom-0 left-0 bg-black m-2 p-4 rounded-md'>
          ...
          <div className='mt-5 flex justify-between items-center gap-2'>
              <div className='flex items-center gap-2'>
                <div className=' w-7 h-7 rounded-full object-cover bg-purple-500 flex justify-center items-center text-white text-xs '>
                  {name[0]}
                </div>
    ...
    // <div className='rounded-xl shadow-xl w-64 h-64'>Hello
    //   <img src={photo} alt={prompt} className='w-full h-auto object-cover rounded-xl'/>
    // </div>
  )
}
